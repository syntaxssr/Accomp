...
app/[locale]/        Localized homepage, roadmap, support, legal and 404 routes
...
components/support/  Bilingual support experience and supporter wall
...
The `/en` and `/th` routes contain the complete marketing story;
`/en/roadmap` and `/th/roadmap` present the planned mobile app direction; and
`/en/support` and `/th/support` explain independent development support. The
